const menu_data = [
  ...
  // ... other menu items
  {
    ...
    has_children: false,
    title: "Account",
    link: "/account/profile", // Link to the profile page
    sub_menus: [
      { link: "/account/profile", title: "Profile" },
      { link: "/account/settings", title: "Settings" }, // Example additional link
      { link: "/account/logout", title: "Logout" }, // Example logout link
    ],
  },
];
